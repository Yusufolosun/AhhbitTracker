...
export function MilestoneRewards() {
  ...
  return (
    <SurfaceCard>
      <h3 className="text-xl font-bold text-surface-900 dark:text-white mb-4">Milestone Rewards</h3>
      ...
      <div className="space-y-6">
        {claimableHabits.map((habit: Habit) => (
          <div
            key={habit.habitId}
            className="border-t border-surface-200 dark:border-surface-700 pt-4 first:border-0 first:pt-0"
          >
                ...
                return (
                  ...
                  >
                    ...
                    {isReached ? (
                      ...
                      <span className="mt-2 text-[10px] font-bold text-surface-400 uppercase">
                        Locked
                      </span>
                    )}
                  </div>
